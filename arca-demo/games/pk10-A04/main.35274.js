...
window.boot = function () {
    ...
    if (false) {
        ...
        var bundledScript = settings.debug ? 'src/project.dev.js' : 'src/project.1a576.js';
        if (jsList) {
...
// main.35274.js is qqplay and jsb platform entry file, so we must leave platform init code here
if (false) {
