...
window.boot = function () {
    ...
    if (false) {
        ...
        var bundledScript = settings.debug ? 'src/project.dev.js' : 'src/project.b7a93.js';
        if (jsList) {
...
// main.384db.js is qqplay and jsb platform entry file, so we must leave platform init code here
if (false) {
